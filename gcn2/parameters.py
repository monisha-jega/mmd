...
num_nodes = max_context_len * (max_utter_len + num_images_in_context)
word_embedding_size = 300
image_size = 4096
image_embedding_size = 512
cell_state_size = 512
gcn_layer1_out_size = 500
gcn_layer2_out_size = 400

batch_size = 100		    		#best value - 64
vocab_freq_cutoff = 4				#best value - 4
learning_rate=0.0004    			#best value - 0.0004
max_gradient_norm = 0.1 			#best value - 0.1
epochs = 1						#best value - Early stopping

consecutive_subject_connections = True    #For GCN
