...
def process_batch(model, data_batch):
	...
	for instance in data_batch:
		...
		batch_target_negs.append(instance[3][:num_neg_images_use])
	...
	#batch_image is [dimension batch_size * max_context_len] 
	#batch_target_pos is [dimension batch_size * 1]
	#batch_target_negs is [dimension batch_size * num_neg_images]
	#
	...
	#batch_text is [batch_size * max_context_len * max_utter_len]
	#batch_image is dimension batch_size * max_context_len * image_size] 
