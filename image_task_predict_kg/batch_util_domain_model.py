...
def pad_for_batch_size(batch_images, batch_gender_targets):
    ...
    return batch_images, batch_gender_targets
...
def process_batch(data_batch):
    ...
    batch_images, batch_gender_targets_list = pad_for_batch_size(batch_images, batch_gender_targets_list)
    
    batch_images = [image_rep(image) for image in batch_images]

    return batch_images, batch_gender_targets_list
